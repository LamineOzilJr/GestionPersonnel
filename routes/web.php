...
Route::middleware('auth')->group(function () {
    ...
    // Routes pour le module de gestion des employés
    ...
    Route::get('/employees/{employee}/generate-salary-slip', [EmployeeController::class, 'generateSalarySlip'])->name('employees.generate-salary-slip');
